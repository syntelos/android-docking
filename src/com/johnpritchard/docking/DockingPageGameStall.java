 ...
 * 
 */
public final class DockingPageGameStall
    extends DockingPageGameView
{

    public final static DockingPageGameStall Instance = new DockingPageGameStall();


    private DockingPageGameStall(){
