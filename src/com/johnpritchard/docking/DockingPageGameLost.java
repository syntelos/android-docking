 ...
 * 
 */
public final class DockingPageGameLost
    extends DockingPageGameView
{

    public final static DockingPageGameLost Instance = new DockingPageGameLost();


    private DockingPageGameLost(){
