...
public enum Page {
    ...
    gamestall    (DockingPageGameStall.Instance,    true),
    gamelost     (DockingPageGameLost.Instance,    true),
    gamedock     (DockingPageGameDock.Instance,    true),
    gamehistory  (DockingPageGameHistory.Instance,     true),
